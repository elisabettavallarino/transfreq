...
from visbrain.io import download_file, is_sc_image_installed
from visbrain.utils import (array2colormap, color2vb, mpl_cmap, normalize,
...
class TopoObj(VisbrainObject):
    ...
    def set_data(self, data, levels=None, level_colors='white', cmap='viridis',
        ...
        if channels is not None:
            self.chan_text.text = [channels[k] for k in ch_idx]
            self.chan_text.pos = xyz[ch_idx,:]
