...
ax1.set_xticks(list(np.arange(1, len(meths)+1)), labels=meths_label[:4], rotation=45, fontsize=ticks_fs)
...
ax2.set_xticks([1], labels=[meths_label[-1]], rotation=45, fontsize=ticks_fs)
